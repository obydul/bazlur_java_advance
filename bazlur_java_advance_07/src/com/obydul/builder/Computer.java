package com.obydul.builder;

import java.util.function.Consumer;
import static com.obydul.builder.Disk.disk;
import static com.obydul.builder.Processor.processor;
...
public class Computer {
	...
	public static void main(String[] args) {
		Computer.create(
				builder -> builder.with(processor().core(2).speed(3).i386()).and(disk().size(512).speed(7200).sata()));
	}
